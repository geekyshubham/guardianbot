...
| Cosign and provenance-bound image promotion | Beta | Critical-clean default-branch images | [release evidence tests](../scripts/release-evidence.test.mjs) | GitHub OIDC and immutable release identity | GuardianBot has earlier live release evidence; the 0.2.6 image is not yet deployed and verified |
