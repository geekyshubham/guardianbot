...
| Cosign and provenance-bound image promotion | Beta | Critical-clean default-branch images | [release evidence tests](../scripts/release-evidence.test.mjs) and [live v0.2.8 evidence](evidence/v0.2.8-digitalocean-app-platform.md) | GitHub OIDC and immutable release identity | GuardianBot v0.2.8 is verified live; consumer-repository promotion remains unverified |
